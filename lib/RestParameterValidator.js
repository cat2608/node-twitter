...
RestParameterValidator.prototype.validateSourceId = function(parameters)
{
    var source_id = parameters['source_id'];
    var types = {'number': true, 'string': true};
    if (source_id !== undefined && types[(typeof source_id)] === false)
    {
        throw new Error('Expected number.');
    }
};

RestParameterValidator.prototype.validateSourceScreenName = function(parameters)
{
    var source_screen_name = parameters['source_screen_name'];
    if (source_screen_name !== undefined && typeof source_screen_name !== 'string')
    {
        throw new Error('Expected string.');
    }
};
...
RestParameterValidator.prototype.validateTargetId = function(parameters)
{
    var target_id = parameters['target_id'];
    var types = {'number': true, 'string': true};
    if (target_id !== undefined && types[(typeof target_id)] === false)
    {
        throw new Error('Expected number.');
    }
};

RestParameterValidator.prototype.validateTargetScreenName = function(parameters)
{
    var target_screen_name = parameters['target_screen_name'];
    if (target_screen_name !== undefined && typeof target_screen_name !== 'string')
    {
        throw new Error('Expected string.');
    }
};
