 ...
 * @param callback The callback function.
 */
RestClient.prototype.followersList = function(parameters, callback)
{
    var screenName = parameters['screen_name'];
    var userId = parameters['user_id'];
    if (screenName === undefined && userId === undefined)
    ...
    this._createGetRequest('followers/list', this._format, parameters, callback);
}
 ...
 * @param callback The callback function.
 */
RestClient.prototype.friendshipsCreate = function(parameters, callback)
{
    this._validator.validateScreenName(parameters);
    this._validator.validateUserId(parameters);
 ...
 * @param callback The callback function.
 */
RestClient.prototype.friendshipsShow = function(parameters, callback)
{
    ...
    // indicate IDs should be returned as strings
    parameters['stringify_ids'] = true;
    this._createGetRequest('friendships/show', this._format, parameters, callback);
}
...
RestClient.prototype.statusesMentions = function(parameters, callback)
{
    ...
    this._createGetRequest('statuses/mentions_timeline', this._format, parameters, callback);
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweeters = function(parameters, callback)
{
    var id = parameters['id'];
    if (id === undefined)
    {
 ...
 * @param callback The callback function.
 */
RestClient.prototype.usersShow = function(parameters, callback)
{
    this._validator.validateScreenName(parameters);
    this._validator.validateUserId(parameters);

    this._createGetRequest('users/show', this._format, parameters, callback);
}
