 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/docs/api/1/get/direct_messages">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.directMessages = function(parameters)
{
    ...
    this._createGetRequest('direct_messages', this._format, parameters, function(error, result) {
 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/docs/api/1/post/direct_messages/destroy/%3Aid">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.directMessagesDestroy = function(parameters)
{
    var promise = new Hope.Promise()
    ...
    this._createPostRequest(resource, this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 * @param callback The callback function.
 */
RestClient.prototype.directMessagesSent = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateCount(parameters);
    this._validator.validateIncludeEntities(parameters);
    ...
    this._createGetRequest('direct_messages/sent', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 * @param callback The callback function.
 */
RestClient.prototype.directMessagesNew = function(parameters)
{
    var promise = new Hope.Promise()
    ...
    this._createPostRequest('direct_messages/new', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 * @param callback The callback function.
 */
RestClient.prototype.followersIds = function(parameters)
{
    var promise = new Hope.Promise()
    ...
    this._createGetRequest('followers/ids', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 *
 * For information on acceptable parameters see the official <a href="https://dev.twitter.com/docs/api/1/get/followers/list">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.followersList = function(parameters)
{
    var promise = new Hope.Promise()
    var screenName = parameters['screen_name'];
    var userId = parameters['user_id'];
    ...
    this._createGetRequest('followers/list', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/docs/api/1/get/friends/ids">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.friendsIds = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateScreenName(parameters);
    this._validator.validateUserId(parameters);
    ...
    this._createGetRequest('friends/ids', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 * @param callback The callback function.
 */
RestClient.prototype.friendsList = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateScreenName(parameters);
    this._validator.validateUserId(parameters);
    ...
    this._createGetRequest('friends/list', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/rest/reference/post/friendships/create">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.friendshipsCreate = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateScreenName(parameters);
    this._validator.validateUserId(parameters);
    ...
    // indicate IDs should be returned as strings
    parameters['stringify_ids'] = true;
    this._createPostRequest('friendships/create', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 * @param callback The callback function.
 */
RestClient.prototype.friendshipsShow = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateSourceScreenName(parameters);
    this._validator.validateSourceId(parameters);
    this._validator.validateTargetId(parameters);
    this._validator.validateTargetScreenName(parameters);

    // To work around JavaScript's inability to handle large numbers
    // indicate IDs should be returned as strings
    parameters['stringify_ids'] = true;
    this._createGetRequest('friendships/show', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 *
 * For information on acceptable parameters see the official
* <a href="https://dev.twitter.com/docs/api/1/get/followers/ids">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.userFavorites = function(parameters)
{
    var promise = new Hope.Promise()
    var screenName = parameters['screen_name'];
    var userId = parameters['user_id'];
    ...
    this._createGetRequest('favorites/list', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/docs/api/1/get/statuses/home_timeline">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param {Dictionary} parameters
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesHomeTimeline = function(parameters)
{
    var promise = new Hope.Promise()
    ...
    this._createGetRequest('statuses/home_timeline', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesMentions = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateContributorDetails(parameters);
    this._validator.validateCount(parameters);
    ...
    this._createGetRequest('statuses/mentions_timeline', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesPublicTimeline = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateCount(parameters);
    this._validator.validateIncludeEntities(parameters);
    ...
    this._createGetRequest('statuses/public_timeline', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweetedByMe = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateCount(parameters);
    this._validator.validateIncludeEntities(parameters);
    ...
    this._createGetRequest('statuses/retweeted_by_me', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweetedByUser = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateCount(parameters);
    this._validator.validateIncludeEntities(parameters);
    ...
    this._createGetRequest('statuses/retweeted_by_user', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweetedToMe = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateCount(parameters);
    this._validator.validateIncludeEntities(parameters);
    ...
    this._createGetRequest('statuses/retweeted_to_me', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweetedToUser = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateCount(parameters);
    this._validator.validateIncludeEntities(parameters);
    ...
    this._createGetRequest('statuses/retweeted_to_user', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/docs/api/1/get/statuses/retweets_of_me">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param {Dictionary} parameters
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweetsOfMe = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateCount(parameters);
    this._validator.validateIncludeEntities(parameters);
    ...
    this._createGetRequest('statuses/retweets_of_me', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
...
/**
 * Retrieves user IDs belonging to users who have retweeted the tweet associated with the specified id parameter.
 *
 * For information on acceptable parameters see the official <a href="https://dev.twitter.com/rest/reference/get/statuses/retweeters/ids">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param {Dictionary} parameters
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweeters = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
    ...
    var resource = 'statuses/retweeters/ids';

    this._createGetRequest(resource, this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesUserTimeline = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateContributorDetails(parameters);
    this._validator.validateCount(parameters);
    ...
    this._createGetRequest('statuses/user_timeline', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 *
 * For information on acceptable parameters see the official
* <a href="https://dev.twitter.com/docs/api/1/post/statuses/destroy/%3Aid">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param {Dictionary} parameters
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesDestroy = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesOEmbed = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/docs/api/1/post/statuses/retweet/%3Aid">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param {Dictionary} parameters
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweet = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweetedBy = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweetedByIds = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesRetweets = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesShow = function(parameters)
{
    var promise = new Hope.Promise()
    var id = parameters['id'];
    if (id === undefined)
 ...
 */
RestClient.prototype.statusesUpdate = function(parameters)
{
    var promise = new Hope.Promise()
 ...
 * @param {Function} callback The callback function.
 */
RestClient.prototype.statusesUpdateWithMedia = function(parameters)
{
    var promise = new Hope.Promise()
    ...
    uploadClient.statusesUpdateWithMedia(parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
};
 ...
 * @param callback The callback function.
 */
RestClient.prototype.usersLookup = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateIncludeEntities(parameters);
    this._validator.validateScreenName(parameters);
    ...
    this._createGetRequest('users/lookup', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 *
 * For information on acceptable parameters see the official
 * <a href="https://dev.twitter.com/docs/api/1/get/users/show">Twitter documenation</a>.
 *
 * @this {RestClient}
 * @param parameters
 * @param callback The callback function.
 */
RestClient.prototype.usersShow = function(parameters)
{
    var promise = new Hope.Promise()
    this._validator.validateScreenName(parameters);
    this._validator.validateUserId(parameters);

    this._createGetRequest('users/show', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
 ...
 * @param callback The callback function.
 */
RestClient.prototype.applicationRateLimitStatus = function(parameters)
{
    var promise = new Hope.Promise()
    this._createGetRequest('application/rate_limit_status', this._format, parameters, function(error, result) {
      promise.done(error, result);
    });
    return promise;
}
